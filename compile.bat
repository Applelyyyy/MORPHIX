...
if %errorlevel% neq 0 (
    ...
    g++ main.cpp -o MORPHIX.exe -lgdi32 -luser32 -lcomctl32 -luxtheme -mwindows 2>nul
) else (
    g++ main.cpp app_res.o -o MORPHIX.exe -lgdi32 -luser32 -lcomctl32 -luxtheme -mwindows 2>nul
    del app_res.o 2>nul
)
